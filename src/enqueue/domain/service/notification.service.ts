...
export class NotificationService {
  ...
  private resolveDefaultProvider(channel: NotificationChannel): NotificationProvider {
    const defaultProvider: Record<NotificationChannel, NotificationProvider> = {
      [NotificationChannel.EMAIL]: envConfig.defaultEmailProvider as NotificationProvider,
      [NotificationChannel.SMS]: envConfig.defaultSmsProvider as NotificationProvider,
    };
